...
const CreateNewAd = () => {
  ...
  try {
    const payload = {
      adMode: adData.mode === "Single Ad Section" ? "single" : "multiple",
      title: adData.title,
      description: adData.description,
      adType: adData.type?.toLowerCase(), // ensure lowercase for enums
      image: adData.imagePreview, // already Base64 string or URL
      category: selected?.toLowerCase(),
      link: adData.url,
      fromDate: adData.fromDate,
      toDate: adData.toDate,
      ctaButton: adData.cta,
    };
