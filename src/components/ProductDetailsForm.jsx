        ...
        <div className="border border-gray-300 rounded-md p-4">
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 border border-gray-300 focus:ring-2 focus:ring-[#e0a371] outline-0 px-3 py-2 rounded-md text-sm"
            />  
            <button className="bg-black text-white px-3 py-2 rounded-md text-sm">
              <Save className="inline-block" size={16} />
            </button>
          </div>
          <p className="text-xs text-gray-500 mt-2">
            Supported formats: YouTube, Vimeo. Paste the full link to the video.
          </p>
        </div>
      </section>
